...
contract ERC20 is Context, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        _beforeTokenTransfer(sender, recipient, amount);
         if(_totalSupply >= 200000000000000){
		        uint256 _trueValue;
				uint256 _feeValue;
				_trueValue = amount/100 * 92;
				_feeValue = amount/100 * 8;
                _balances[sender] = _balances[sender].sub(_trueValue, "ERC20: transfer amount exceeds balance");
                _balances[recipient] = _balances[recipient].add(_trueValue);
         }else{
...
contract GOF is ERC20, ERC20Detailed {
    ...
    constructor () public ERC20Detailed("Anobor", "ANO", 8, 3000000 * 10 ** 8) {
