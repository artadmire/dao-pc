...
contract GOFTokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(0x195985c564CACA32E961Cb71334520948a8651d9);
...
contract GOFGTPool is GOFTokenWrapper, IRewardDistributionRecipient {
    
    IERC20 public gof = IERC20(0x195985c564CACA32E961Cb71334520948a8651d9);
    ...
    function getStakeTime(address account)  external view returns (uint256) {
        return stakeTime[account];
    }
    ...
    function getGOFBalance() external view returns (uint256) {
        return gof.balanceOf(address(this));
    }
    
    function getSenderGOFBalance() external view returns (uint256) {
        uint256 b = gof.balanceOf(msg.sender);
        return b;
